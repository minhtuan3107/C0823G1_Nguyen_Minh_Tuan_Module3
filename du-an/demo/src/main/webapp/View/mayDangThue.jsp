...
<div class="container-fluid">
  <table class="table table-striped ">
    ...
    <tr>
      ...
      <td> <a class="btn btn-primary" href="/may-chua-thue-servlet?action=chuathue">Máy trống</a></td>
      <td ></td>
      <td colspan="2"> <a  class="btn btn-warning  " href="/may-tinh-servlet">Trang Quản Lý</a></td>
      <td></td>
    </tr>
    ...
    <c:forEach items="${mayDangThue}" var="item">
      ...
      <tr>
        <td><a href="/may-tinh-servlet?action=detail&id=${item.maMayTinh.idMayTinh}">${item.maMayTinh.tenMayTinh}</a></td>
        <td> ${item.gioBatDau}</td>

        <td>
          <a type="button" href="/may-dang-thue-servlet?action=orderFood&id=${item.maMayTinh.idMayTinh}" class="btn btn-secondary" >
            Thêm dịch vụ
          </a>
        </td>
        <td>
          <a type="button" href="/may-dang-thue-servlet?action=orderUsed&id=${item.maMayTinh.idMayTinh}" class="btn btn-secondary" >
            Xem dịch vụ
          </a>
        </td>
        <td>
          <a class="btn btn-danger" href=" /may-tinh-servlet?action=endTime&idMay=${item.maMayTinh.idMayTinh}">Tắt máy</a>
        </td>

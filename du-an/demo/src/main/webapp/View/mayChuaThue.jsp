...
<div class="container-fluid">
  ...
  <table class="table table-striped">
    <tr>
      ...
      <td> <a class="btn btn-primary" href="/may-dang-thue-servlet?action=dangthue">Máy đang sử dụng</a></td>
      <td> <a  class="btn btn-warning " href="/may-tinh-servlet">Trang Quản Lý</a></td>
    </tr>
    ...
    <c:if test="${empty mayChuaThue}">
      <tr>
        <td style="font-size: 26px" colspan="5" class=" text-danger text-center">Máy đã được sử dụng hết.</td>
      </tr>
    </c:if>
    <c:forEach items="${mayChuaThue}" var="mayTinh">
      ...
      <tr>
        ...
        <td>  <a class="btn btn-info"  href="/may-tinh-servlet?action=startTime&idMay=${mayTinh.idMayTinh}" >Mở Máy</a>
        </td>

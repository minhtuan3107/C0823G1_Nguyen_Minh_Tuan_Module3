...
public class DichVuDiKemRepository implements IDichVuDiKemRepository {
    ...
    private final String XOA_DICH_VU_DI_KEM = "delete from dich_vu_di_kem where id = ?;";
    private final String SUA_DICH_VU_DI_KEM = "update dich_vu_di_kem set ten_dich_vu_di_kem = ? ,gia_dich_vu_di_kem = ? , id_loai_dich_vu = ? where id = ?;";
    ...
    public void themDichVuDiKem(DichVuDiKem dichVuDiKem) {
        ...
        try {
            ...
            preparedStatement.setObject(3, dichVuDiKem.getMaLoaiDichVu());

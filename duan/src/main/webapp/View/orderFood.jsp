    ...
    <form action="/may-dang-thue-servlet" method="get">
        ...
        <table class="table table-hover  table-striped">
            <tr>
                ...
                <td></td>
                <td></td>
                <td><a href="/may-dang-thue-servlet" class="btn btn-primary">Máy đang sử dụng</a></td>
            </tr>
            <tr class="bg-success">
                <th>#</th>
                <th>Tên dịch vụ</th>
                ...
                <tr>
                    ...
                    <td class="quantity-controls">
                        <input class="btn btn-danger" type="button" value="-"
                               onclick="adjustQuantity(${item.idDichVuDiKem}, 'GIAM')">
                        <p id="show-quantity${item.idDichVuDiKem}">0</p>

                        <input class="btn btn-primary" type="button" value="+"
                               onclick="adjustQuantity(${item.idDichVuDiKem}, 'TANG')">
                    </td>
                    <input type="hidden" name="quantity${item.idDichVuDiKem}" id="quantity${item.idDichVuDiKem}" value="0">

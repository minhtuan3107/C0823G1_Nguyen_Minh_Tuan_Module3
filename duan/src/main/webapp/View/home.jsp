...
<table class="table table-light container-fluid table-hover">
  <tr>
    <td colspan="4"><p style="font-size: 30px" class="text-center fw-bold">Quản lý phòng máy</p></td>
    <td></td>
  </tr>

  <tr>
    <td> <a class="btn btn-info" href="/may-dang-thue-servlet?action=dangthue">Máy đang sử dụng</a></td>

    <td></td>
    <td colspan="3"> <a class="btn btn-secondary" href="/may-chua-thue-servlet?action=chuathue">Máy trống</a></td>
